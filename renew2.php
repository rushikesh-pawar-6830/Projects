...
// $type=$_GET['type'];
// $degree=$_GET['degree'];
// $sql="insert into `info` (`name`,`email`,`prn`,`start`,`end`,`route`,`phon`,`dep`,`degree`) values ('$name','$email','$prn','$start','$end','$route','$phon','$dep','$degree')";
// $sql2="insert into `info` (`end`,`route`,`phon`,`dep`,`degree`) values ('$end','$route','$phon','$dep','$degree')";
...
if (isset($_POST['upload'])) {
   ...
   echo$filename;
    ...
    $sql = "INSERT INTO payment (filename) VALUES ('$filename')";
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarCenteredExample">
                <ul class="navbar-nav mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        ...
                        <button type="button" class="btn btn-outline-primary mx-3"><a
                                class=" fw-bold nav-link active text-white" aria-current="page" href="renew.html">Renew
                                Pass</a></button>
                    </li>
        ...
        <div class="wrapper">
                <div id="wizard">
                    ...
                    <section>
                       ...
                       <h5> <div class="form-row my-4">  Amount:-5000 </div></h5>
